...
class _RecommendedState extends State<Recommended> {
  ...
  void initState() {
    super.initState();
    recommendedMovies = ApiManager().getTopRatedMovies(); // Fetch recommended movies from API
  }
            ...
            child: FutureBuilder<List<Movie>>(
              ...
              builder: (context, snapshot) {
                if (snapshot.hasError) {
                  ...
                  // If data is available, display the list of movie items
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  movie.voteAverage.toString(), // Movie rating from API
                                  style: Theme.of(context)
                                      .textTheme
                                      .bodySmall
                            ...
                            Text(
                              movie.releaseDate != null
                                  ? "${movie.releaseDate!.year}  ${movie.voteAverage?.toString()} " // Movie details (year, rating)
                                  : "No Release Date",
                              style: Theme.of(context)
                                  .textTheme
                                  .bodySmall
